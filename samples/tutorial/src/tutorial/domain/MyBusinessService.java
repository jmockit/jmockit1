 ...
 * Its usage is as simple as it gets: <code>new MyBusinessService(data).doBusinessOperationXyz()</code>.
 ...
 * Since all interaction with the facade is through <code>static</code> methods, client classes cannot be unit tested with a
 ...
 * <code>static</code> methods don't require an instance of the mocked class at all).
 * <p>
 ...
 * As demonstrated here, sending an e-mail is simply a matter of instantiating the appropriate <code>Email</code> subclass,
 * setting the necessary properties, and calling the <code>send()</code> method.
 ...
 * the judicious use of <code>final</code> for <code>public</code> and <code>protected</code> methods is important.
 ...
 * For JMockit, on the other hand, whether a method or class to be mocked is <code>final</code> or not is irrelevant, as a
