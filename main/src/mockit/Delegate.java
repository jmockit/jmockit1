 ...
 * <p/>
 * When combined with the <tt>result</tt> field, a test will typically assign it with an anonymous class object implementing this interface
 ...
 * mocked method or mocked constructor is invoked; it can contain any number of <tt>private</tt> or <tt>static</tt> methods, though.
 ...
 * The delegate method is also allowed to have <em>no</em> parameters (without counting the optional <tt>Invocation</tt> parameter).
 * <p/>
 * When used with the <tt>result</tt> field, the result of a delegate method execution can be any return value compatible with the recorded
