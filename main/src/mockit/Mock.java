 ...
 * <p>
 * Method modifiers (<code>public</code>, <code>final</code>, <code>static</code>, etc.) between fake and faked methods <em>don't</em> have to be
 * the same.
 * It's perfectly fine to have a non-<code>static</code> fake method for a <code>static</code> faked method (or vice-versa), for example.
 ...
 * <p>
 * Another special fake method, "<strong><code>void $clinit()</code></strong>", will target the <code>static</code> initializers of the faked
