 ...
 * inject <em>non-mocked</em> (real) instances when applied as <tt>@Tested(fullyInitialized = true)</tt>.
 ...
 * <p/>
 * {@linkplain mockit.MockUp <code>MockUp&lt;T></code>} is a generic base class (where <tt>T</tt> is the type to be faked) which allows the
 ...
 * <tt>private</tt> field needs to be accessed.
 * <p/>
