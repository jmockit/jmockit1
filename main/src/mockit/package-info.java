 ...
 * where the record phase can be left empty, with expected invocations verified explicitly <em>after</em> exercising the
 * code under test (ie, after the replay phase).
 * <p/>
