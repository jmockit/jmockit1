...
public class Invocation
{
    ...
    * {@linkplain Injectable injectable mocked type} nor to a
    * {@linkplain Expectations#Expectations(Object...) dynamic partially mocked type}, into a <tt>native</tt> method, or into an interface
    * or abstract method
    *
