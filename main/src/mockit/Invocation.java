...
public class Invocation
{
   ...
   /**
    * Returns the instance on which the current invocation was made, or <tt>null</tt> for a <tt>static</tt> method invocation.
    */
   @Nullable
   ...
   /**
    * Returns the <tt>Method</tt> or <tt>Constructor</tt> object corresponding to the target method or constructor, respectively.
    */
   @Nonnull
    ...
    * <p/>
    * In the case of a method, the real implementation is executed with the argument values originally received or explicitly given as replacement.
    ...
    * Contrary to proceeding into a method, it's not possible to actually execute test code inside the delegate or fake method after proceeding into
    * the real constructor, nor to proceed into it more than once.
    *
    * @param replacementArguments the argument values to be passed to the real method, as replacement for the values received by the delegate or fake
    *                             method; if those received values should be passed without replacement, then this method should be called with no
    *                             values
    ...
    * {@linkplain Injectable injectable mocked type} nor to a {@linkplain Expectations#Expectations(Object...) dynamic partially mocked type}, into a
    * <tt>native</tt> method, or into an interface or abstract method
    *
